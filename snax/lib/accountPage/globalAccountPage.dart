  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: showAppBar ? getTheme(context).appBarColor : Colors.transparent,
        ...
        Column(
          ...
          children: [
            Text(
              ...
              style: TextStyle(fontSize: 20, color: getTheme(context).appBarContrastForText()),
            ),
            SizedBox(height: 5),
            Text(
              "@" + this.widget.user.username,
              style: TextStyle(fontSize: 15, color: (getTheme(context).appBarBrightness() == Brightness.light) ? Colors.black54: Colors.white60),
            ),
          ],
        ),
      ],
                      ...
                      children: [
                        (bioText != null)
                            ? Text(
                                bioText,
                                style: TextStyle(
                                    color: getTheme(context).appBarContrastForText(), fontSize: 15),
                                maxLines: _maxLines,
                              )
                            : Container(),
                        numLines >= 4
              ...
              Container(
                child: RaisedButton(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(color: getTheme(context).appBarContrastForText(), width: 2),
                  ),
                  onPressed: () {
